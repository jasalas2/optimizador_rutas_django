...
urlpatterns = [
    ...
    path("resultados/recalcular-camion/", views.api_recalcular_camion_manual, name="api_recalcular_camion_manual"),
    path("resultados/guardar-ajuste/", views.api_guardar_ajuste_manual, name="api_guardar_ajuste_manual"),
